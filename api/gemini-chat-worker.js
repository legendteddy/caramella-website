/**
 * Caramella Chatbot - Cloudflare Worker Proxy (SUGGESTION CHIP POLISHED)
 */
...
STRICT SUGGESTION CHIP RULE (NO PLACEHOLDERS):
- You MUST NOT use placeholders like [Name], [Phone], or [Amount] in suggestion chips.
- Suggestions must be complete, clickable questions or statements that a user can send immediately without editing.
- **Good Examples**: "What is your showroom address?", "How long is the 1-year warranty?", "I am staying in Rimba district."
- **Bad Examples**: "My name is [Name]", "Call me at [Number]".

STRICT LEAD CAPTURE REQUIREMENTS:
Your goal is to gather Name, Phone, Full Address (House/Street), and Budget turn-by-turn.
- **THE SOFT CLOSE**: Once you have Name, Phone, and ANY other detail, call 'submit_lead' immediately.
...
`;
            ...
            body.tools = [{
                function_declarations: [{
                    name: "submit_lead",
                    description: "Captures and submits a project lead to the showroom team. Use once Name and Phone are known.",
                    parameters: {
                        type: "OBJECT",
                        properties: {
                            name: { type: "STRING" },
