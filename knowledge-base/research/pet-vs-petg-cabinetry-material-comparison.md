...
```mermaid
flowchart LR
    usage[High-traffic use] --> D[Damage initiation]
    D --> A[Surface scratches/abrasion]
    D --> B[UV exposure → yellowing/degradation]
    D --> C[Moisture/thermal cycling]
    A --> E[Finish dulling & micro-cracking]
    B --> E
    C --> F[Substrate swelling or adhesive failure]
    E --> G[Appearance loss]
    F --> G
    G --> H[Repair or Replacement]
```
...
```mermaid
timeline
    title Expected Service Life (High-Traffic Kitchen Door)
    0–5 yrs      : *Excellent:* Near-original appearance; very minor, barely visible micro-scratches.
    5–10 yrs     : *Good:* Some visible scratches and mild gloss loss; possible onset of slight yellowing on PETG.
    10–15 yrs    : *Fair:* Noticeable surface wear, moderate dulling/yellowing; edge seal may weaken.
    15+ yrs      : *End-of-life:* Aesthetic quality faded; risk of delamination or permanent damage; replacement recommended.
```
...
flowchart LR
    ...
    A --> E[Finish dulling & micro-cracking]
    B --> E
    C --> F[Substrate swelling/delamination]
    E --> G[Appearance loss]
    F --> G
    G --> H[Repair/Replacement]
```

```mermaid
timeline
    title Expected Service Life (Kitchen Doors)
    0–5 yrs      : *Excellent:* Near-original appearance; minimal micro-scratches.
    5–10 yrs     : *Good:* Noticeable scratches, slight gloss loss or yellowing.
    10–15 yrs    : *Fair:* Moderate surface wear, dulling, minor adhesive fatigue.
    15+ yrs      : *Poor:* Significant damage; replacement recommended.
```
